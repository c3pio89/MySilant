    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.client', verbose_name='Клиент')),
                ('model_driving_axle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.drivingaxle', verbose_name='Модель ведущего моста')),
                ('model_engine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='machines_engine', to='mySilant.equipment', verbose_name='Модель двигателя')),
                ('model_equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='machines_equipment', to='mySilant.equipment', verbose_name='Модель техники')),
            ],
            options={
                'verbose_name': 'Машина',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.machine', verbose_name='Машина')),
                ('maintenance_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.maintenancecompany', verbose_name='Организация, проводившая ТО')),
                ('service_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.servicecompany', verbose_name='Сервисная компания')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.typemaintenance', verbose_name='Вид ТО')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.steeringaxle', verbose_name='Модель управляемого моста'),
        ),
        migrations.AddField(
            model_name='machine',
            name='model_transmission',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.transmission', verbose_name='Модель трансмиссии'),
        ),
        migrations.AddField(
            model_name='machine',
            name='service_company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.servicecompany', verbose_name='Сервисная компания'),
        ),
        migrations.CreateModel(
            name='Claim',
            fields=[
                ...
                ('machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.machine', verbose_name='Машина')),
                ('recovery_method', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.recoverymethod', verbose_name='Способ восстановления')),
                ('refusal_node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.refusalnode', verbose_name='Узел отказа')),
                ('service_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mySilant.servicecompany', verbose_name='Сервисная компания')),
            ],
            options={
